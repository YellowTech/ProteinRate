"""
Django settings for ProteinRate project.
...
# SECRET comes from secret.py, set this accordingly
SECRET_KEY = SECRET
...
WSGI_APPLICATION = 'ProteinRate.wsgi.application'
